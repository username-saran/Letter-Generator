...
public class Leave extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		outPrintWriter.print("<!DOCTYPE html>\r\n"
				...
				+ "                              Sub:Requisition for Leave\r\n"
				+ "                              <br>\r\n"
				+ "                              &nbsp;&nbsp;&nbsp;As i was suffering from leave ,i was unable to attend the class. Hence i request you to grant me leave for "+difference_In_Days+" days ["+startDateString+","+endDateString+"]\r\n"
				+ "                              <br>\r\n"
